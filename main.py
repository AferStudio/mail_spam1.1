...
MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMmddddddmMMMMMMMMMMMh--oMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM""" + colorama.Fore.BLUE + "\n\n-----------------------------------------------------------\n\n" + colorama.Fore.GREEN + "Telegram: KoderFG" + colorama.Fore.RED + "\nYoutube: D.UnfiXxx\n" + colorama.Fore.YELLOW + "Сайт: https://github.com/FoxCubBot/mail_spam1.0\n")
